...
class CredentialConfiguration(interface.AttributeContainer):
    ...
    def __init__(self, credential_data=None, credential_type=None, path_spec=None):
...
class ExtractionConfiguration(interface.AttributeContainer):
    ...
    Attributes:
      ...
      hasher_names_string (str): comma separated names of hashers to use during
          processing.
      max_file_size (int): maximum file size in bytes that the extraction
          worker should process, where 0 or None represents no limit.
