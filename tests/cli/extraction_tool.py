...
usage: extraction_tool_test.py [--single_process] [--max_file_size SIZE]
                               [--file_date_start DATE] [--file_date_end DATE]
...
{test_lib.ARGPARSE_OPTIONS}:
  --file_date_end, --file-date-end DATE
                        End of the file date range filter. Files whose access,
                        modification and creation timestamps all fall outside
                        the specified range will be skipped. Format: YYYY-MM-
                        DD or YYYY-MM-DD hh:mm:ss. Default timezone is UTC.
  --file_date_start, --file-date-start DATE
                        Start of the file date range filter. Files whose
                        access, modification and creation timestamps all fall
                        outside the specified range will be skipped. Format:
                        YYYY-MM-DD or YYYY-MM-DD hh:mm:ss. Default timezone is
                        UTC.
  --max_file_size, --max-file-size SIZE
                        Maximum file size in bytes that the extraction worker
                        should process. Files larger than this limit will be
                        skipped. A value of 0 (default) means no limit.
...
{test_lib.ARGPARSE_OPTIONS}:
  --file_date_end DATE, --file-date-end DATE
                        End of the file date range filter. Files whose access,
                        modification and creation timestamps all fall outside
                        the specified range will be skipped. Format: YYYY-MM-
                        DD or YYYY-MM-DD hh:mm:ss. Default timezone is UTC.
  --file_date_start DATE, --file-date-start DATE
                        Start of the file date range filter. Files whose
                        access, modification and creation timestamps all fall
                        outside the specified range will be skipped. Format:
                        YYYY-MM-DD or YYYY-MM-DD hh:mm:ss. Default timezone is
                        UTC.
  --max_file_size SIZE, --max-file-size SIZE
                        Maximum file size in bytes that the extraction worker
                        should process. Files larger than this limit will be
                        skipped. A value of 0 (default) means no limit.
  --single_process, --single-process
